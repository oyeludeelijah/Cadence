...
function CreateTask({ onTaskCreated }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 3. Bulk-insert checkpoints (percentages from template)
      ...
      setMessage({ type: 'success', text: `"${form.title.trim()}" created with ${checkpoints.length} checkpoints.` })
